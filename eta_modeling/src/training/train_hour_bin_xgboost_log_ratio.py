...
MODEL_NAME = "hour_bin_xgb_log_ratio_eta"
...
def main() -> None:
    ...
    configure_mlflow(config, "eta_fixed_trip_hour_bin_xgboost_log_ratio")
    ...
    with mlflow.start_run(run_name=MODEL_NAME):
        ...
        log_ratio_path = paths["plots_dir"] / f"{MODEL_NAME}_target_vs_prediction.csv"
        pd.DataFrame({

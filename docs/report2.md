...
- [Report 2: Comparison of New ETA Correction Formulas](#report-2-comparison-of-new-eta-correction-formulas)
  - [Mục lục](#mục-lục)
  - [1. Mục tiêu](#1-mục-tiêu)
  - [2. Giải thích các công thức residual mới](#2-giải-thích-các-công-thức-residual-mới)
    - [2.1 Multiplicative / Ratio Correction](#21-multiplicative--ratio-correction)
    - [2.2 Affine Correction](#22-affine-correction)
    - [2.3 Log-ratio Correction](#23-log-ratio-correction)
  - [3. Kết quả các phương pháp dùng công thức mới](#3-kết-quả-các-phương-pháp-dùng-công-thức-mới)
  - [4. So sánh với các phương pháp cũ](#4-so-sánh-với-các-phương-pháp-cũ)
    - [4.1 So sánh với additive residual baselines](#41-so-sánh-với-additive-residual-baselines)
    - [4.2 So sánh với các model ML/deep cũ](#42-so-sánh-với-các-model-mldeep-cũ)
  - [5. So sánh các phương pháp mới với nhau](#5-so-sánh-các-phương-pháp-mới-với-nhau)
    - [5.1 Ratio correction](#51-ratio-correction)
    - [5.2 Log-ratio correction](#52-log-ratio-correction)
    - [5.3 Affine correction with Huber Regression](#53-affine-correction-with-huber-regression)
  - [6. Kết luận: công thức và phương pháp nên chọn](#6-kết-luận-công-thức-và-phương-pháp-nên-chọn)
    - [6.1 Mục tiêu chính là MAE](#61-mục-tiêu-chính-là-mae)
    - [6.2 Mục tiêu chính là giảm lỗi lớn / tail-error](#62-mục-tiêu-chính-là-giảm-lỗi-lớn--tail-error)
...
### 6.2 Mục tiêu chính là giảm lỗi lớn / tail-error
...
Không chọn làm primary ở giai đoạn hiện tại:
